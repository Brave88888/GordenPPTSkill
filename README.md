...
>
> ⚠️ **非商业使用**：本仓库及内置模板**仅供个人学习与研究**，禁止任何商业用途。模板素材来自第三方设计师作品，商用请向原作者获得授权。
...
- 内置模板均来自公开的 PPT 模板分享渠道（如稻壳儿 / WPS / 党政机关公开模板），版权归原作者所有
- 本仓库重新整理了模板的结构化元数据 + 编辑工具，不主张对模板设计本身的版权
- **任何二次分发 / 商业使用，请联系模板原作者获取授权**
